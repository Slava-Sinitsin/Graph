...
public:
    ...
    explicit GraphMatrixForm(bool directed) { this->directed = directed; }
    ...
    int DeleteEsFromVertex(int index, bool directed_) {
        int size = matrix.size();
        int deleted = 0;
...
public:
    explicit GraphListForm(bool directed) { this->directed = directed; }
